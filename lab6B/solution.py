#!/usr/bin/env python2
# This is a slightly adjusted version of https://github.com/Corb3nik/MBE-Solutions/blob/master/lab6b/solution.py (the original kept claiming about invalid input arguments so I hardcoded the remote variant)
from pwn import *
